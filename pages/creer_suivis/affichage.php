...
<h2 class="plan_act" id="plan_action">Suivi du plan d'actions</h2>
<div class="tableau" id="tabl">
    ...
    ?>
    <h2 class="plan_act" id="rendez_vous">Suivi des rendez-vous</h2>
...
<div class="tableau" id="tabl">
    ...
    <form class="form" method="post">
        ...
        <textarea class="form-control" name="info_comp" id="empl_occ" disabled><?php echo $ligne2["info_comp"] ?></textarea>
    <?php
    }
    ?>
    <hr>
    ...
    foreach($resultat as $ligne3){
        if($ligne3["type_formation"]=="cdd" || $ligne3["type_formation"]=="cdi" || $ligne3["type_formation"]=="formation" || $ligne3["type_formation"]=="stage" || $ligne3["type_formation"]=="abandon" || $ligne3["type_formation"]=="non_retour" || $ligne3["type_formation"]=="autre_s"){
    ?>

        <label for="situat_pro">Situation professionnelle après la clôture du plan d'action : </label>
        <select class="form-control" name="type_formation" id="situat_pro" onchange="hideshowsituationpro()" disabled>
            <option value="rien">-- Selectionner une option --</option>
        ...
        <input type="text" id="type_post" name="poste_occupe" value="<?php echo $ligne3["poste_occupe"] ?>"disabled>
        <label for="duree_hebdo">Durée hebdomadaire : </label>
        <input type="text" id="duree_hebdo" name="duree_hebdo" value="<?php echo $ligne3["duree_hebdo"] ?>"disabled>
        <label for="nom_societe">Nom de la société : </label>
        <input type="text" id="nom_societe" name="nom_societe" value="<?php echo $ligne3["nom_societe"] ?>"disabled>
        </div>
        <label for="emploi_aide">Emploi aidé : </label>
        <input type="radio" id="help_oui" name="emploi_aide" value="oui" disabled <?php
        ...
        <input type="radio" id="help_non" name="emploi_aide" value="non" disabled<?php
        ...
        <input type="text" id="type_post2" name="poste_occupe_cdd" value="<?php echo $ligne3["poste_occupe_cdd"] ?>"disabled>
        <label for="duree_hebdo2">Durée hebdomadaire : </label>
        <input type="text" id="duree_hebdo2" name="duree_hebdo_cdd" value="<?php echo $ligne3["duree_hebdo_cdd"] ?>"disabled>
        <label for="nom_societe2">Nom de la société : </label>
        <input type="text" id="nom_societe2" name="nom_societe_cdd" value="<?php echo $ligne3["nom_societe_cdd"] ?>"disabled>
        </div>
        <label for="emploi_aide_cdd">Emploi aidé : </label>
        <input type="radio" id="help_oui2" name="emploi_aide_cdd" value="oui" disabled<?php
        if($ligne3["emploi_aide_cdd"]=="oui"){
            echo "checked";
        }
        ?>>
        <label for="help_oui2">oui</label>
        <input type="radio" id="help_non2" name="emploi_aide_cdd" value="non" disabled<?php
        ...
        <select class="form-control" name="type_form_after" id="form_type1" onchange="hideshowformqd1()"disabled>
        ...
        <input type="text" id="nom_form" name="nom_form_qual" value="<?php echo $ligne3["nom_form_qual"] ?>"disabled>
        </div>
        <label for="duree_qual">Durée de la formation qualifiante : </label>
        <input type="text" id="duree_qual" name="duree_form_qual" value="<?php echo $ligne3["duree_form_qual"] ?>"disabled>
        </div>
        <!--    Si diplômante   -->
        <div class="input_boxe" id="if_dipl1">
        <label for="nom_diplo1">Nom de la formation diplômante : </label>
        <input type="text" id="nom_diplo1" name="nom_form_dipl" value="<?php echo $ligne3["nom_form_dipl"] ?>"disabled>
        
        <div class="input_boxe">
        <label for="duree_dipl">Durée de la formation diplômante : </label>
        <input type="text" id="duree_dipl" name="duree_form_dipl" value="<?php echo $ligne3["duree_form_dipl"] ?>"disabled>
        </div>
        </div>
        <!--   Si stage   -->
        <div id="stage">
        ...
        <input type="text" id="type_post3" name="nom_stage" value="<?php echo $ligne3["nom_stage"] ?>"disabled>
        <label for="duree_hebdo3">Durée : </label>
        <input type="text" id="duree_hebdo3" name="duree_stage" value="<?php echo $ligne3["duree_stage"] ?>"disabled>
        <label for="nom_societe3">Nom de l'organisme : </label>
        <input type="text" id="nom_societe3" name="nom_org_stage" value="<?php echo $ligne3["nom_org_stage"] ?>"disabled>
        </div>
        </div>
        <!--   Si abandon   -->
        <div id="abandon">
        ...
        <input type="text" id="abandon_raison" name="abandon" value="<?php echo $ligne3["abandon"] ?>"disabled>
        </div>
        </div>
        ...
        <input type="text" id="non_empl" name="non_retour" value="<?php echo $ligne3["non_retour"] ?>"disabled>
        </div>
        </div>
        <!--   Si autre   -->
        <div id="siautre">
        ...
        <input type="text" id="autre_situ" name="autre" value="<?php echo $ligne3["autre"] ?>"disabled>
        <?php
    }}
    ?>
    </div>
